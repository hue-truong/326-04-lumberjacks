...
async function fetchCompany1(){
    const company1 = await fetch(`/companies/get-jobs`
    , {
      method: 'GET',
    });
...
async function fetchCompany2(){
    const company2 = await fetch(`/companies/get-jobs`
    , {
      method: 'GET',
    });
...
async function fetchCompany3(){
    const company3 = await fetch(`/companies/get-jobs`
    , {
      method: 'GET',
    });
...
async function fetchCompany4(){
    const company4 = await fetch(`/companies/get-jobs`
    , {
      method: 'GET',
    });
